...
s=sin;p=[(x/w*2-1,(y/20*2-1)*0.2)|y<-[0..20],x<-[0..w+1]];t=max 0;o=True;a=abs
...
go n=puts("\ESCc" <> (u(n/6)<$>p))>>threadDelay 100000>>go(n+1);h p@(x,y,z)=let
 ...
 d=h(a,y,b);g|nz<0='o'|ny<0='>'|o='.';r|d<0.01=g|o=m t(n+1)(x,y,z+d)in r
-- ^10 ------------------------------------------------------------------ 80> --
{- default-10-80/lambda-bind (tristanC)
